...
DROP USER SCPT CASCADE;
CREATE USER SCPT IDENTIFIED BY SCPT;
...
--concessione dei privilegi di lettura e scrittura sulle directory all'utente SCPT
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  SCPT.SEQ_ID_CARICAMENTI;
   CREATE SEQUENCE  SCPT.SEQ_ID_RUN;
   CREATE SEQUENCE  SCPT.SEQ_ID_MASTER;
   CREATE SEQUENCE  SCPT.SEQ_ID_LOG;
 
--------------------------------------------------------
--  DDL for Table SCP_TAB01_DATA
--------------------------------------------------------

drop table SCPT.SCP_TAB01_DATA;
...
--------------------------------------------------------
--  DDL for Table SCP_TAB01_SCARTI
--------------------------------------------------------
drop table SCPT.SCP_TAB01_SCARTI;
  ...
  --------------------------------------------------------
--  DDL for Table SCP_TAB_LOG
-------------------------------------------------------- 
   CREATE TABLE SCPT.SCP_TAB_LOG
(
    ID_LOG      NUMBER PRIMARY KEY,        -- ID univoco del log
    DATA_LOG    DATE DEFAULT SYSDATE,      -- Data e ora del log
    STEP        VARCHAR2(100 BYTE),        -- Nome dello step o descrizione
    LOG_MSG   VARCHAR2(4000 BYTE)        -- Eventuali messaggi o dettagli
);
